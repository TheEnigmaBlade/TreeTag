...
TREE_REGROW_TIME = 1800.0                 -- How long should it take individual trees to respawn after being cut down/destroyed?
...
TEAM_COLORS[DOTA_TEAM_GOODGUYS] = { 101, 212, 19 }
TEAM_COLORS[DOTA_TEAM_BADGUYS]  = { 243, 27, 9 }
